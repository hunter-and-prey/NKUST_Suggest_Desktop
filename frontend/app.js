...
const I18N = {
  zh: {
    ...
    hint_content_calc: "依校務規範：中文字與英數字均為 1:1 計算，僅換行折算 2 字元。",
  ...
  en: {
    ...
    hint_content_calc: "Per campus rules: text is 1:1, only line breaks count as 2 characters.",
  ...
  ja: {
    ...
    hint_content_calc: "本校規定：文字は1:1計算（改行のみ2文字として計算されます）。",
